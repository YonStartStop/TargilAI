...
צריך להסביר לצעירים על התהליך, על דברים שחשוב לזכור בדרך לקלפי ועל פרטיות ההצבעה, על האופציות להתפקד במפלגה, ולהסביר למה גם קול קטן משפיע מאוד, לאור אירועים בשנים האחרונות ואיך הם יכולים לשפר את מצב המדינה ואת חייהם בדרך ישירה ומשמעותית.

שלוש חלקי התוכן צריכים להסביר על:
1. למה חשוב להצביע, מה זה נותן לכם, ושזה כדאי ושווה את הזמן
2. איך מחליטים למי להצביע בקלפי ותהליך מחקר עצמאי מותאם לגיל - זה יכול להיות בסרטונים ובהפנייה למדיה החברתית של מפלגות.
3. הפרקטיקה של איך מצביעים, איך יודעים איפה הקלפי שלך, פרטיות וכו׳
